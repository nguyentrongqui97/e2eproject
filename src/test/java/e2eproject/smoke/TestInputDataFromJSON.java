...
public class TestInputDataFromJSON extends Hooks {

    public TestInputDataFromJSON() throws IOException {
        super();
    }
    ...
    public void TestInputData() throws IOException, Exception {
        ...
        // Read data
        JSONObject testData = JsonReader.readJson("src\\main\\java\\e2eproject\\testData\\TestData2.json");
